                    ...
                    <div class="table-responsive table-sm" style="height: 360px;overflow: auto;">
                      <table class="table table-bordered table-hover table-xs" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                          ...
                          $i=1;
                          include '../config/koneksi.php';
                          $data = mysqli_query($koneksi, "SELECT * FROM user WHERE role_id=2");
                          while($dp = mysqli_fetch_array($data)){
                            ...
                            <tr>
                              ...
                              <td width="20%" style="text-align: center;"><?= $dp['spesialis']; ?></td>
            ...
            <div class="modal-body">
              ...
              <div class="form-group">
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control" id="umur" name="umur" placeholder="Umur Dokter">
                  </div>
                </div>
              ...
              <div class="modal-body">
                ...
                <div class="form-group">
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                      <input type="text" class="form-control" id="spesialis" name="spesialis" value="<?= $dp['spesialis'] ?>">
                    </div>
                    <input type="hidden" id="role_id" name="role_id" value="2">
                  </div>
